...
WORKING-STORAGE SECTION.
    ...
    01 ADDED-BLOCKS            BINARY-LONG UNSIGNED VALUE 0.
...
PROCEDURE DIVISION.
    ...
    *> Initialize BLOCK-COUNT and apply additions based on environment
    ACCEPT BLOCK-COUNT FROM ENVIRONMENT "BLOCK-COUNT".
    ACCEPT ADDED-BLOCKS FROM ENVIRONMENT "ADDED-BLOCKS".
    ADD ADDED-BLOCKS TO BLOCK-COUNT.

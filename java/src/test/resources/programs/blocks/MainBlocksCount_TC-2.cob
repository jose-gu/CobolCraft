...
PROGRAM-ID. MainBlocksCount_TC-2.
...
PROCEDURE DIVISION.
    DISPLAY "MainBlocksCount_TC-2 started".

    ACCEPT WS-RESULT-FILE-PATH FROM ENVIRONMENT "RESULT_FILE_PATH".

    *> Initialize BLOCKS structure from environment (empty structure => BLOCK-COUNT = 0)
    ...
    *> Write outputs to result file
    ...
    GOBACK.
END PROGRAM MainBlocksCount_TC-2.
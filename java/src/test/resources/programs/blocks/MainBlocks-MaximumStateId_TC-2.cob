*> Main wrapper for TC-2: Retrieve Maximum State ID after initialization
IDENTIFICATION DIVISION.
PROGRAM-ID. MainBlocks-MaximumStateId_TC-2.
...
PROCEDURE DIVISION.
    DISPLAY "MainBlocks-MaximumStateId_TC-2 started".
    ...
    *> Write output parameter to result file
    ...
    GOBACK.
END PROGRAM MainBlocks-MaximumStateId_TC-2.

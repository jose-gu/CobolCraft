...
PROGRAM-ID. MainBlocks-MaximumStateId_TC-3.
...
PROCEDURE DIVISION.
    ...
    *> Initialize shared BLOCKS structure to reflect highest state ID = 2500
    ...
    *> Write outputs to result file
    ...
    GOBACK.
END PROGRAM MainBlocks-MaximumStateId_TC-3.

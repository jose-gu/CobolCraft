...
PROGRAM-ID. MainBlocks-GetDefaultStateId_TC-3.
...
PROCEDURE DIVISION.
    ...
    ADD 1 TO LK-BLOCK-ID GIVING WS-IDX.
    MOVE 42 TO BLOCK-ENTRY-DEFAULT-STATE-ID(WS-IDX).
    ...
    GOBACK.
END PROGRAM MainBlocks-GetDefaultStateId_TC-3.

...
PROGRAM-ID. Main-BlocksGetDefaultStateId-TC-4.
...
WORKING-STORAGE SECTION.
    ...
    01 LK-STATE-ID_DISPLAY PIC 9(10).
    01 OUTPUT-LINE PIC X(80) VALUE SPACES.
    01 WS-RESULT-FILE-PATH PIC X(100).

PROCEDURE DIVISION.
    DISPLAY "Main-BlocksGetDefaultStateId started".
    ...
    *> Write outputs to file
    ...
    GOBACK.
END PROGRAM Main-BlocksGetDefaultStateId-TC-4.

...
PROGRAM-ID. MainBlocksMaximumStateId_TC-5.
...
PROCEDURE DIVISION.
    DISPLAY "MainBlocksMaximumStateId_TC-5 started".

    *> Accept result file path from environment
    ACCEPT WS-RESULT-FILE-PATH FROM ENVIRONMENT "RESULT_FILE_PATH".

    *> Initialize BLOCKS structure to reflect highest ID after removal
    ...
    *> Write outputs to file
    ...
    GOBACK.
END PROGRAM MainBlocksMaximumStateId_TC-5.
